...
//		
		instructions.add(selectPivotCmd);
		instructions.add("Starting with the right half, pick the pivot (middle) element.");
		
		instructions.add(cachePivotCmd);
		instructions.add("Now, hide the pivot on the far right (swap).");
		
		instructions.add(endLowPtrCmd);
		instructions.add("Scan over all the red elements, and mark the last one blue.");
		
		instructions.add(endHighPtrCmd);
		instructions.add("Nice, scan over the larger (blues) with the blue ptr.");
		...
		instructions.add("But algorithms are rigid, they cannot just skip steps...");
		...
		instructions.add("Now we only have 1 element to pick a pivot from...");
		...
		instructions.add("Base cases are essentially end the of recursion.");
		instructions.add(baseCaseSelectCmd);
		instructions.add("Let's go ahead and mark this one as correctly positioned.");
		...
		instructions.add("Let's give you a little more control and see if you can sort a bigger array.");
