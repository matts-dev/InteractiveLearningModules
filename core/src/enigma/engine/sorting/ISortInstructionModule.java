...
public class ISortInstructionModule extends CourseModule {
	...
	private SortType sortType = SortType.INSERTION;
	 ...
	 */
	public ISortInstructionModule(OrthographicCamera camera) {
		super(camera);
