...
public class MultiplicationModule extends CourseModule {
	...
	public MultiplicationModule(OrthographicCamera camera) {
		...
		multEntity = new MultiplicationEntity(1952.5f, 14, Gdx.graphics.getWidth() / 2, getHeightPositionForLDEntity(), false);
	...
	private void calculateNewRandomDivision() {
		...
		multEntity = new MultiplicationEntity(numerator, denominator, Gdx.graphics.getWidth() / 2, getHeightPositionForLDEntity(), false);
	}
