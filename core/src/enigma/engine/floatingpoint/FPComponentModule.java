...
public abstract class FPComponentModule extends CourseModule {
	...
	public void setValueToSolveStringReference(final DrawableString numberToSolve)
	{
	...
	{
		if(instruction != null && instructionList != null)
		{
			if(currentInstructionPointer >= 0 && currentInstructionPointer < instructionList.size())
			{
				instruction.startAnimation();
				instruction.setText(instructionList.get(currentInstructionPointer));
			}
		}
	}
	
	//TODO make this abstract once the ability to finish through module is complete
